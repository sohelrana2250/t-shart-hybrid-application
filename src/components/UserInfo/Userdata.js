...
const Userdata = () => {
    ...
    useEffect(() => {
        fetch('Data.json').then((res) => res.json()).then((data) => setUserdata(data)).catch((error) => console.log(error?.message));
            ...
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                <div class="flex items-center justify-between pb-4">
                    ...
                    <div class="relative">
                        ...
                        <input onChange={(e) => setSearchUser(e.target.value)} type="text" id="table-search" class="block p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg w-80 bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search for items" />
                    </div>
                </div>
                    ...
                    <tbody>
                        {
                            userdata?.filter((item) => {
                                return searchUser.toLowerCase() === "" ? item : item.first_name.toLowerCase().includes(searchUser) || item.last_name.toLowerCase().includes(searchUser)
                            }).map((v, index) => <tr key={index} class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                <td class="w-4 p-4">
                                    <div class="flex items-center">
